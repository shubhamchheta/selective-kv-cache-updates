...
Modern operating systems also use containers to isolate applications. 
Containers allow applications to run in separate environments while sharing 
the operating system kernel. Docker is a widely used container platform.

Containers are useful because they are lightweight and can be started quickly.
They are commonly used for software development, testing, and deployment.
The operating system kernel, containers share while running applications
"""
